	...
	methods = {
		init: function (element, options) {
			...
			if(opts.topButtons && stepsBar.length && !topActions.length){
				...
				html += '<span class="btn btn-default btn-mini btn-xs btn-next"><span class="next-text">'+ opts.text.next +'</span><span id="finishedUp" class="finished-text">'+ opts.text.finished +'</span></span>';
				html += '</div></div>';
			...
			if(opts.bottomButtons && !bottomActions.length){
				...
				html += '<span class="btn btn-default btn-mini btn-xs btn-prev"><span class="previous-text">'+ opts.text.previous +'</span></span>';
				html += '<span class="btn btn-default btn-mini btn-xs btn-next"><span class="next-text">'+ opts.text.next +'</span><span id="finishedDown" class="finished-text">'+ opts.text.finished +'</span></span>';
				html += '</div><br><br>';
