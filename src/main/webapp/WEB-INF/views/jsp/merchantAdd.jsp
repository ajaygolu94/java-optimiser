...
<html lang="en">
  <head>
	...
	<title><s:message code="app.title.addmerchant" arguments="${applicationScope['APPLICATION_HEADER_TEXT']}"/></title>
    	...
    	<div class="row">
        	<div class="col-md-12 add">
            	<div class="col-md-12 head">
                	<h4> <s:message code="label.add.merchant"/></h4>
                </div>
                <div class="col-md-12 bottom">
                	<div class="col-md-12 head1">
                 		<h5> <a href="${pageContext.request.contextPath}/home"><s:message code="app.link.home"/></a>  /  
                 		<a href="${pageContext.request.contextPath}/merchant" > <s:message code="app.title.listmerchant"/></a>  /  
                 		<s:message code="form.merchant.create"/></h5>
                    </div>
                	<div class="col-md-12 head1">
                    ...
                    <div class="col-md-12 downForm">
                    	...
                    	<form name="merchantform" class="form-main" id="merchantform" role="form" data-toggle="validator" method="post">
                    		
                    		<input type="hidden" id="userId" name="userId" value="${applicationUser.userId}">
	                            	...
	                            	<tr>
	                                    ...
	                                    <td class="list2Form">
	                                    	<input type="text" name="username" id="username" maxlength="64" size="50" 
	                                    		   value="${applicationUser.name}" class="form-control" readonly="true" tabindex="1">
	               		...
	               		<div class="actionDiv">
	               			<a href="#" id="saveMerchantBtn" class="btn-box">
...
<script type="text/javascript">
	$(document).ready(function() {
		...
		$("#saveMerchantBtn").click(function(){
	       ...
	       var merchant = $('#merchantform').serializeObject();
